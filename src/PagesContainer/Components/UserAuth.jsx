    ...
    <>
      <div className='flex flex-col justify-center items-start text-white gap-1'>
        ...
        <div className='flex justify-center items-center gap-3 w-full md:w-96 rounded-md px-4 py-1 bg-gray-200'>
          ...
          <input type={passwordCheck ? inputType :  "text"} placeholder={placeHolder} value={value} className={` flex-1 w-full h-full outline-none border-none py-2 bg-transparent text-text555 text-md ${isEmailValid && placeHolder === "Email" && "border-2 border-red-700"}`} onChange={userDataHandler} />
          {
            isPass && (
